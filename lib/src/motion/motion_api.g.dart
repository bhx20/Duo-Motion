...
import 'package:flutter/foundation.dart' show immutable, protected, visibleForTesting;
...
class DuoMotionHostApi {
  ...
  Future<MotionMetrics> metrics() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.duo_motion.DuoMotionHostApi.metrics$pigeonVar_messageChannelSuffix';
  ...
  Future<void> stop() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.duo_motion.DuoMotionHostApi.stop$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
Stream<MotionFrame> streamMotion( {String instanceName = ''}) {
  ...
  final EventChannel streamMotionChannel =
      EventChannel('dev.flutter.pigeon.duo_motion.DuoMotionEventApi.streamMotion$instanceName', pigeonMethodCodec);
