...
# Run `pod lib lint duo_motion.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'duo_motion'
  s.version          = '1.0.0'
...
A tilt-driven frosted-glass fold effect for Flutter widgets.
                       DESC
  s.homepage         = 'https://github.com/bhx20/duo_motion'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Sanket Kalathiya' => '89138565+bhx20@users.noreply.github.com' }
  s.source           = { :path => '.' }
  ...
  s.source_files = 'duo_motion/Sources/duo_motion/**/*.swift'
  ...
  # App Store review.
  s.resource_bundles = {'duo_motion_privacy' => ['duo_motion/Sources/duo_motion/PrivacyInfo.xcprivacy']}
end
