...
@ConfigurePigeon(
  PigeonOptions(
    ...
    dartPackageName: 'duo_motion',
    kotlinOut:
        'android/src/main/kotlin/dev/duomotion/duo_motion/MotionApi.g.kt',
    kotlinOptions: KotlinOptions(package: 'dev.duomotion.duo_motion'),
    swiftOut: 'ios/duo_motion/Sources/duo_motion/MotionApi.g.swift',
  ),
)
